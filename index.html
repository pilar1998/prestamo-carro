...
<html lang="en">
<head>
<title>Prestamo Carro Nuevo</title>
...
<div class="header">
	<div class="agile-top-header">
		<div class="logo">
			<h1><a>Prestamo<span>Carro</span></a></h1>
		</div>	
	</div>
</div>
	<!--Slider-->
<div class="slider">
	<div class="callbacks_container">
		...
		<div class="main" >
			...
			<h3>Formulario de Prestamo Carro</h3>
			</div> 		
				<form action="prestamo.php" method="post" class="w3_form_post"  name="formulario" >
					<div class="agileits_w3layouts_main_grid w3ls_main_grid">
						<div class="agileinfo_grid">
						<h3 class="w3_main_grid_left" style="color: white">Valor Carro</h3><h3 style="color: red">*</h3>
							<br>
							<br>
							<div class="agileits_w3layouts_main_gridl">
								<h3 style="color: white">$ <input type="number" name="carro" id="carro" style="color: black" required=""> pesos</h3>
							</div>
					...
					<div class="agileits_w3layouts_main_grid w3ls_main_grid">
						<div class="agileinfo_grid">
						<h3 class="w3_main_grid_left" style="color: white">Cuota Inicial</h3><h3 style="color: red"></h3>
							<br>
							<br>
							<div class="agileits_w3layouts_main_gridl">
...
<script type="text/javascript">
	window.onload = (function(){
		try{
		    $("#carro").on('keyup', function(){
		        carro = document.formulario.carro.value;
		        pres=carro*0.2;
			...
			$('#button').on('click', function(event) {
				event.preventDefault();
					...
					datos="&carro="+carro+"&plazo="+plazo+"&pres="+pres;
				if (carro!=''){						
					$.ajax({
						type: "post",
						url:"prestamo.php",
